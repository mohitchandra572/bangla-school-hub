...
const menuItems = {
  ...
  teacher: [
    { icon: LayoutDashboard, label: 'ড্যাশবোর্ড', href: '/dashboard/teacher' },
    { icon: Users, label: 'আমার শিক্ষার্থী', href: '/dashboard/teacher/my-students' },
    ...
    { icon: UserCheck, label: 'প্রোফাইল', href: '/dashboard/teacher/profile' },
  ],
  parent: [
